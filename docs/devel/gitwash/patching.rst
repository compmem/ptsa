...
::
   ...
   git clone git://github.com/compmem/ptsa.git
...
Then, send the generated patch files to the `ptsa
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `ptsa mailing list`_.
...
Fork the `ptsa`_ repository on github |emdash| :ref:`forking`.
Then::
   ...
   git remote add origin git@github.com:your-user-name/ptsa.git
