/* Generated by Cython 0.12.1 on Wed May 12 21:45:06 2010 */
...
typedef __pyx_t_5numpy_float64_t __pyx_t_3edf_dtype_f64_t;
...
/* Module declarations from edf */

static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_3edf_dtype_f64_t = { "edf.dtype_f64_t", NULL, sizeof(__pyx_t_3edf_dtype_f64_t), 'R' };
#define __Pyx_MODULE_NAME "edf"
int __pyx_module_is_main_edf = 0;

/* Implementation of edf */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static char __pyx_k_1[] = "Error opening file.";
static char __pyx_k_2[] = "Error reading annotation %d";
static char __pyx_k_3[] = "onsets,durations,annotations";
...
static char __pyx_k_10[] = "read_annotations (line 44)";
static char __pyx_k_11[] = "read_samplerate (line 99)";
static char __pyx_k_12[] = "read_samples (line 136)";
...
static char __pyx_k__onset[] = "onset";
...
static char __pyx_k__dtype_f64[] = "dtype_f64";
static char __pyx_k__edfsignal[] = "edfsignal";
static char __pyx_k__ValueError[] = "ValueError";
static char __pyx_k__annotation[] = "annotation";
static char __pyx_k__fromarrays[] = "fromarrays";
static char __pyx_k__suboffsets[] = "suboffsets";
static char __pyx_k__RuntimeError[] = "RuntimeError";
static char __pyx_k__read_samples[] = "read_samples";
static char __pyx_k__read_samplerate[] = "read_samplerate";
static char __pyx_k__read_annotations[] = "read_annotations";
static char __pyx_k__annotations_in_file[] = "annotations_in_file";
...
static PyObject *__pyx_n_s__annotations_in_file;
...
static PyObject *__pyx_n_s__onset;
static PyObject *__pyx_n_s__range;
static PyObject *__pyx_n_s__read_annotations;
static PyObject *__pyx_n_s__read_samplerate;
...
/* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":44
 *                                double *buf)
 * 
...
static PyObject *__pyx_pf_3edf_read_annotations(PyObject *__pyx_self, PyObject *__pyx_arg_filepath); /*proto*/
static char __pyx_doc_3edf_read_annotations[] = "\n    read_annotations(filepath)\n\n    Read in all the annotations from an EDF/BDF file into a record\n    array. Note that the onset times converted to seconds.\n\n    Parameters\n    ----------\n    filepath : {str}\n        The path and name of the EDF/BDF file.\n\n    Returns\n    -------\n    annotations : {np.recarray}\n        A record array with onsets, duration, and annotations.\n    \n    ";
static PyObject *__pyx_pf_3edf_read_annotations(PyObject *__pyx_self, PyObject *__pyx_arg_filepath) {
  char *__pyx_v_filepath;
  struct edf_hdr_struct __pyx_v_hdr;
  struct edf_annotation_struct __pyx_v_annot;
  PyArrayObject *__pyx_v_onsets = 0;
  PyObject *__pyx_v_durations;
  PyObject *__pyx_v_annotations;
  PyObject *__pyx_v_i;
  Py_buffer __pyx_bstruct_onsets;
  Py_ssize_t __pyx_bstride_0_onsets = 0;
  Py_ssize_t __pyx_bshape_0_onsets = 0;
  ...
  int __pyx_t_8;
  int __pyx_t_9;
  __Pyx_RefNannySetupContext("read_annotations");
  __pyx_self = __pyx_self;
  assert(__pyx_arg_filepath); {
    __pyx_v_filepath = __Pyx_PyBytes_AsString(__pyx_arg_filepath); if (unlikely((!__pyx_v_filepath) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("edf.read_annotations");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_v_durations = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_annotations = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_i = Py_None; __Pyx_INCREF(Py_None);
  __pyx_bstruct_onsets.buf = NULL;

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":66
 * 
 *     # open the file
 ...
 *         return None
 */
  __pyx_t_1 = (open_file_readonly(__pyx_v_filepath, (&__pyx_v_hdr), EDFLIB_READ_ALL_ANNOTATIONS) < 0);
  if (__pyx_t_1) {

    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":67
 *     # open the file
 *     if open_file_readonly(filepath, &hdr, EDFLIB_READ_ALL_ANNOTATIONS) < 0:
 *         print "Error opening file."             # <<<<<<<<<<<<<<
 *         return None
 ...
 */
    ...
    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":68
 *     if open_file_readonly(filepath, &hdr, EDFLIB_READ_ALL_ANNOTATIONS) < 0:
 *         print "Error opening file."
 *         return None             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":74
 * 
 ...
 */
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":75
 *     # this could be improved
 *     cdef np.ndarray[dtype_f64_t, ndim=1] onsets = np.empty(
 *         hdr.annotations_in_file,dtype=dtype_f64)             # <<<<<<<<<<<<<<
 *     durations = []
 *     annotations = []
 */
  __pyx_t_2 = PyLong_FromLongLong(__pyx_v_hdr.annotations_in_file); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     annotations = []
 */
  __pyx_t_5 = __Pyx_GetName(__pyx_m, __pyx_n_s__dtype_f64); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_2, ((PyObject *)__pyx_n_s__dtype), __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyEval_CallObjectWithKeywords(__pyx_t_3, __pyx_t_4, ((PyObject *)__pyx_t_2)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_5);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_onsets, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_3edf_dtype_f64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_onsets = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_onsets.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_bstride_0_onsets = __pyx_bstruct_onsets.strides[0];
      __pyx_bshape_0_onsets = __pyx_bstruct_onsets.shape[0];
    }
  }
  __pyx_t_6 = 0;
  __pyx_v_onsets = ((PyArrayObject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":76
 *     cdef np.ndarray[dtype_f64_t, ndim=1] onsets = np.empty(
 *         hdr.annotations_in_file,dtype=dtype_f64)
 *     durations = []             # <<<<<<<<<<<<<<
 *     annotations = []
 ...
 */
  ...
  __Pyx_DECREF(__pyx_v_durations);
  __pyx_v_durations = ((PyObject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":77
 *         hdr.annotations_in_file,dtype=dtype_f64)
 *     durations = []
 *     annotations = []             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_v_annotations = ((PyObject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":80
 * 
 *     # loop over annotations
 ...
 */
  __pyx_t_5 = PyLong_FromLongLong(__pyx_v_hdr.annotations_in_file); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __pyx_t_5 = 0;
  __pyx_t_5 = PyObject_Call(__pyx_builtin_range, __pyx_t_2, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyList_CheckExact(__pyx_t_5) || PyTuple_CheckExact(__pyx_t_5)) {
    __pyx_t_7 = 0; __pyx_t_2 = __pyx_t_5; __Pyx_INCREF(__pyx_t_2);
  } else {
    __pyx_t_7 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_t_5); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
  }
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  for (;;) {
    ...
    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":81
 *     # loop over annotations
 *     for i in range(hdr.annotations_in_file):
 *         if edf_get_annotation(hdr.handle, i, &annot):             # <<<<<<<<<<<<<<
 *             print "Error reading annotation %d" % (i)
 *             return None
 */
    __pyx_t_8 = __Pyx_PyInt_AsInt(__pyx_v_i); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_t_9 = edf_get_annotation(__pyx_v_hdr.handle, __pyx_t_8, (&__pyx_v_annot));
    if (__pyx_t_9) {

      /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":82
 *     for i in range(hdr.annotations_in_file):
 *         if edf_get_annotation(hdr.handle, i, &annot):
 *             print "Error reading annotation %d" % (i)             # <<<<<<<<<<<<<<
 *             return None
 * 
 */
      __pyx_t_5 = PyNumber_Remainder(((PyObject *)__pyx_kp_s_2), __pyx_v_i); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      if (__Pyx_PrintOne(__pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

      /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":83
 *         if edf_get_annotation(hdr.handle, i, &annot):
 *             print "Error reading annotation %d" % (i)
 *             return None             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":86
 * 
 *         # append the annotations
 ...
 */
    __pyx_t_5 = PyLong_FromLongLong(__pyx_v_annot.onset); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    if (PyObject_SetItem(((PyObject *)__pyx_v_onsets), __pyx_v_i, __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":87
 *         # append the annotations
 *         onsets[i] = annot.onset #/EDFLIB_TIME_DIMENSION
 *         durations.append(annot.duration)             # <<<<<<<<<<<<<<
 *         annotations.append(annot.annotation)
 * 
 */
    __pyx_t_5 = __Pyx_PyBytes_FromString(__pyx_v_annot.duration); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(((PyObject *)__pyx_t_5));
    __pyx_t_4 = __Pyx_PyObject_Append(__pyx_v_durations, ((PyObject *)__pyx_t_5)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(((PyObject *)__pyx_t_5)); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":88
 *         onsets[i] = annot.onset #/EDFLIB_TIME_DIMENSION
 *         durations.append(annot.duration)
 *         annotations.append(annot.annotation)             # <<<<<<<<<<<<<<
 * 
 *     # close the file
 */
    __pyx_t_4 = __Pyx_PyBytes_FromString(__pyx_v_annot.annotation); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(((PyObject *)__pyx_t_4));
    __pyx_t_5 = __Pyx_PyObject_Append(__pyx_v_annotations, ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":91
 * 
 *     # close the file
 ...
 */
  edfclose_file(__pyx_v_hdr.handle);

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":94
 * 
 *     # return record array of annotations
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__rec); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__fromarrays); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":95
 *     # return record array of annotations
 *     return np.rec.fromarrays(
 *         [onsets/EDFLIB_TIME_DIMENSION,durations,annotations],             # <<<<<<<<<<<<<<
 *         #[onsets,durations,annotations],
 ...
 */
  __pyx_t_5 = PyInt_FromLong(EDFLIB_TIME_DIMENSION); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = __Pyx_PyNumber_Divide(((PyObject *)__pyx_v_onsets), __pyx_t_5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  PyList_SET_ITEM(__pyx_t_5, 1, __pyx_v_durations);
  __Pyx_GIVEREF(__pyx_v_durations);
  __Pyx_INCREF(__pyx_v_annotations);
  PyList_SET_ITEM(__pyx_t_5, 2, __pyx_v_annotations);
 ...
 */
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_5));
  if (PyDict_SetItem(__pyx_t_5, ((PyObject *)__pyx_n_s__names), ((PyObject *)__pyx_kp_s_3)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = PyEval_CallObjectWithKeywords(__pyx_t_2, __pyx_t_4, ((PyObject *)__pyx_t_5)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_5)); __pyx_t_5 = 0;
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_onsets);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_onsets);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_onsets);
  __Pyx_DECREF(__pyx_v_durations);
  __Pyx_DECREF(__pyx_v_annotations);
  __Pyx_DECREF(__pyx_v_i);
...
/* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":99
 *         names='onsets,durations,annotations')
 * 
...
static PyObject *__pyx_pf_3edf_read_samplerate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_3edf_read_samplerate[] = "\n    read_samplerate(filepath, edfsignal)\n\n    Read the samplerate for a signal in an EDF/BDF file.  Note that\n    different signals can have different samplerates.\n\n    Parameters\n    ----------\n    filepath : {str}\n        The path and name of the EDF/BDF file.\n    edfsignal : {int}\n        The signal whose samplerate to retrieve.\n        \n    Returns\n    -------\n    samplerate : {float}\n        The samplerate for that signal.\n\n    ";
static PyObject *__pyx_pf_3edf_read_samplerate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  char *__pyx_v_filepath;
  int __pyx_v_edfsignal;
  struct edf_hdr_struct __pyx_v_hdr;
  float __pyx_v_samplerate;
  PyObject *__pyx_r = NULL;
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__filepath,&__pyx_n_s__edfsignal,0};
  __Pyx_RefNannySetupContext("read_samplerate");
  __pyx_self = __pyx_self;
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      case  1:
      values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__edfsignal);
      if (likely(values[1])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("read_samplerate", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "read_samplerate") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_filepath = __Pyx_PyBytes_AsString(values[0]); if (unlikely((!__pyx_v_filepath) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_edfsignal = __Pyx_PyInt_AsInt(values[1]); if (unlikely((__pyx_v_edfsignal == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
    goto __pyx_L5_argtuple_error;
  } else {
    __pyx_v_filepath = __Pyx_PyBytes_AsString(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((!__pyx_v_filepath) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_edfsignal = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_edfsignal == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("read_samplerate", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("edf.read_samplerate");
  return NULL;
  __pyx_L4_argument_unpacking_done:;

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":123
 * 
 *     # open the file
 ...
 *         return None
 */
  __pyx_t_1 = (open_file_readonly(__pyx_v_filepath, (&__pyx_v_hdr), EDFLIB_DO_NOT_READ_ANNOTATIONS) < 0);
  if (__pyx_t_1) {

    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":124
 *     # open the file
 *     if open_file_readonly(filepath, &hdr, EDFLIB_DO_NOT_READ_ANNOTATIONS) < 0:
 *         print "Error opening file."             # <<<<<<<<<<<<<<
 *         return None
 * 
 */
    if (__Pyx_PrintOne(((PyObject *)__pyx_kp_s_1)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":125
 *     if open_file_readonly(filepath, &hdr, EDFLIB_DO_NOT_READ_ANNOTATIONS) < 0:
 *         print "Error opening file."
 *         return None             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":129
 *     # get the samplerate
 ...
 *     # close the file
 */
  __pyx_v_samplerate = get_samplerate((&__pyx_v_hdr), __pyx_v_edfsignal);

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":132
 * 
 *     # close the file
 *     edfclose_file(hdr.handle)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":134
 *     edfclose_file(hdr.handle)
 * 
 *     return samplerate             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_samplerate); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
/* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":136
 *     return samplerate
 * 
 * def read_samples(char *filepath, int edfsignal, long offset, int n):             # <<<<<<<<<<<<<<
 *     """
...
static PyObject *__pyx_pf_3edf_read_samples(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_3edf_read_samples[] = "\n    read_samples(filepath, edfsignal, offset, n)\n\n    Read in samples from a signal in an EDF/BDF file.\n\n    Parameters\n    ----------\n    filepath : {str}\n        The path and name of the EDF/BDF file.\n    edfsignal : {int}\n        The signal whose samplerate to retrieve.\n    offset : {long}\n        Offset in samples into the file where to start reading.\n    n : {int}\n        Number of samples to read, starting at offset.\n        \n    Returns\n    -------\n    samples : {np.ndarray}\n        An ndarray of samples read from the file.\n\n    ";
static PyObject *__pyx_pf_3edf_read_samples(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  char *__pyx_v_filepath;
  int __pyx_v_edfsignal;
  long __pyx_v_offset;
  int __pyx_v_n;
  ...
  int __pyx_t_6;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__filepath,&__pyx_n_s__edfsignal,&__pyx_n_s__offset,&__pyx_n_s__n,0};
  __Pyx_RefNannySetupContext("read_samples");
  __pyx_self = __pyx_self;
  if (unlikely(__pyx_kwds)) {
    Py_ssize_t kw_args = PyDict_Size(__pyx_kwds);
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("read_samples", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__offset);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("read_samples", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__n);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("read_samples", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "read_samples") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_filepath = __Pyx_PyBytes_AsString(values[0]); if (unlikely((!__pyx_v_filepath) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_edfsignal = __Pyx_PyInt_AsInt(values[1]); if (unlikely((__pyx_v_edfsignal == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_offset = __Pyx_PyInt_AsLong(values[2]); if (unlikely((__pyx_v_offset == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    ...
    __pyx_v_filepath = __Pyx_PyBytes_AsString(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((!__pyx_v_filepath) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_edfsignal = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_edfsignal == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_offset = __Pyx_PyInt_AsLong(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_offset == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("read_samples", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("edf.read_samples");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_bstruct_buf.buf = NULL;

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":160
 *     """
 *     # allocate space
 ...
 */
  ...
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__empty); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 160; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_4 = __Pyx_GetName(__pyx_m, __pyx_n_s__dtype_f64); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 160; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__dtype), __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 160; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyEval_CallObjectWithKeywords(__pyx_t_2, __pyx_t_3, ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 160; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_buf, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_3edf_dtype_f64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_buf = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_buf.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 160; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_bstride_0_buf = __pyx_bstruct_buf.strides[0];
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":166
 * 
 *     # open the file
 *     if open_file_readonly(filepath, &hdr, EDFLIB_DO_NOT_READ_ANNOTATIONS) < 0:             # <<<<<<<<<<<<<<
 *         print "Error opening file."
 *         return None
 */
  __pyx_t_6 = (open_file_readonly(__pyx_v_filepath, (&__pyx_v_hdr), EDFLIB_DO_NOT_READ_ANNOTATIONS) < 0);
  if (__pyx_t_6) {

    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":167
 *     # open the file
 *     if open_file_readonly(filepath, &hdr, EDFLIB_DO_NOT_READ_ANNOTATIONS) < 0:
 *         print "Error opening file."             # <<<<<<<<<<<<<<
 *         return None
 * 
 */
    if (__Pyx_PrintOne(((PyObject *)__pyx_kp_s_1)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 167; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":168
 *     if open_file_readonly(filepath, &hdr, EDFLIB_DO_NOT_READ_ANNOTATIONS) < 0:
 *         print "Error opening file."
 *         return None             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":175
 *                                             offset,
 *                                             n,
 ...
 *     if nread < 0:
 */
  __pyx_v_nread = read_samples_from_file((&__pyx_v_hdr), __pyx_v_edfsignal, __pyx_v_offset, __pyx_v_n, ((__pyx_t_3edf_dtype_f64_t *)__pyx_v_buf->data));

  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":177
 *                                             <dtype_f64_t*>buf.data)
 * 
 *     if nread < 0:             # <<<<<<<<<<<<<<
 ...
 *         nread = 0
 */
  __pyx_t_6 = (__pyx_v_nread < 0);
  if (__pyx_t_6) {

    /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":179
 *     if nread < 0:
 *         # we had an error, so return none
 *         nread = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":182
 * 
 *     # close the file
 *     edfclose_file(hdr.handle)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":185
 * 
 *     # return the buffer, truncated to the number of samples
 *     return buf[0:nread]             # <<<<<<<<<<<<<<
 * 
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = PySequence_GetSlice(((PyObject *)__pyx_v_buf), 0, __pyx_v_nread); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 185; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_r = __pyx_t_4;
  __pyx_t_4 = 0;
  goto __pyx_L0;
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":187
...
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":193
 *             # of flags
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":194
 *             cdef int copy_shape, i, ndim
 *             cdef int endian_detector = 1
 *             cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":196
 *             cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)
 * 
 *             ndim = PyArray_NDIM(self)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":198
 *             ndim = PyArray_NDIM(self)
 * 
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):             # <<<<<<<<<<<<<<
 *                 copy_shape = 1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":199
 * 
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 *                 copy_shape = 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":201
 *                 copy_shape = 1
 *             else:
 *                 copy_shape = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":203
 *                 copy_shape = 0
 * 
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":204
 * 
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_C_CONTIGUOUS)):             # <<<<<<<<<<<<<<
 *                 raise ValueError(u"ndarray is not C contiguous")
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":205
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_C_CONTIGUOUS)):
 *                 raise ValueError(u"ndarray is not C contiguous")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":207
 *                 raise ValueError(u"ndarray is not C contiguous")
 * 
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":208
 * 
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_F_CONTIGUOUS)):             # <<<<<<<<<<<<<<
 *                 raise ValueError(u"ndarray is not Fortran contiguous")
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":209
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_F_CONTIGUOUS)):
 *                 raise ValueError(u"ndarray is not Fortran contiguous")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":211
 *                 raise ValueError(u"ndarray is not Fortran contiguous")
 * 
 *             info.buf = PyArray_DATA(self)             # <<<<<<<<<<<<<<
 *             info.ndim = ndim
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":212
 * 
 *             info.buf = PyArray_DATA(self)
 *             info.ndim = ndim             # <<<<<<<<<<<<<<
 *             if copy_shape:
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":213
 *             info.buf = PyArray_DATA(self)
 *             info.ndim = ndim
 *             if copy_shape:             # <<<<<<<<<<<<<<
 *                 # Allocate new buffer for strides and shape info. This is allocated
 ...
 */
  ...
  if (__pyx_t_6) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":216
 *                 # Allocate new buffer for strides and shape info. This is allocated
 *                 # as one block, strides first.
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":217
 *                 # as one block, strides first.
 *                 info.strides = <Py_ssize_t*>stdlib.malloc(sizeof(Py_ssize_t) * ndim * 2)
 *                 info.shape = info.strides + ndim             # <<<<<<<<<<<<<<
 *                 for i in range(ndim):
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":218
 *                 info.strides = <Py_ssize_t*>stdlib.malloc(sizeof(Py_ssize_t) * ndim * 2)
 *                 info.shape = info.strides + ndim
 *                 for i in range(ndim):             # <<<<<<<<<<<<<<
 *                     info.strides[i] = PyArray_STRIDES(self)[i]
 ...
 */
    ...
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":219
 *                 info.shape = info.strides + ndim
 *                 for i in range(ndim):
 *                     info.strides[i] = PyArray_STRIDES(self)[i]             # <<<<<<<<<<<<<<
 *                     info.shape[i] = PyArray_DIMS(self)[i]
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":220
 *                 for i in range(ndim):
 *                     info.strides[i] = PyArray_STRIDES(self)[i]
 *                     info.shape[i] = PyArray_DIMS(self)[i]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":222
 *                     info.shape[i] = PyArray_DIMS(self)[i]
 *             else:
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":223
 *             else:
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)             # <<<<<<<<<<<<<<
 *             info.suboffsets = NULL
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":224
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)
 *             info.suboffsets = NULL             # <<<<<<<<<<<<<<
 *             info.itemsize = PyArray_ITEMSIZE(self)
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":225
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)
 *             info.suboffsets = NULL
 *             info.itemsize = PyArray_ITEMSIZE(self)             # <<<<<<<<<<<<<<
 *             info.readonly = not PyArray_ISWRITEABLE(self)
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":226
 *             info.suboffsets = NULL
 *             info.itemsize = PyArray_ITEMSIZE(self)
 *             info.readonly = not PyArray_ISWRITEABLE(self)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":229
 * 
 *             cdef int t
 *             cdef char* f = NULL             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":230
 *             cdef int t
 *             cdef char* f = NULL
 *             cdef dtype descr = self.descr             # <<<<<<<<<<<<<<
 *             cdef list stack
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":234
 *             cdef int offset
 * 
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":236
 *             cdef bint hasfields = PyDataType_HASFIELDS(descr)
 * 
 *             if not hasfields and not copy_shape:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":238
 *             if not hasfields and not copy_shape:
 *                 # do not call releasebuffer
 *                 info.obj = None             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":241
 *             else:
 *                 # need to call releasebuffer
 *                 info.obj = self             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":243
 *                 info.obj = self
 * 
 *             if not hasfields:             # <<<<<<<<<<<<<<
 *                 t = descr.type_num
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":244
 * 
 *             if not hasfields:
 *                 t = descr.type_num             # <<<<<<<<<<<<<<
 *                 if ((descr.byteorder == '>' and little_endian) or
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":245
 *             if not hasfields:
 *                 t = descr.type_num
 *                 if ((descr.byteorder == '>' and little_endian) or             # <<<<<<<<<<<<<<
 *                     (descr.byteorder == '<' and not little_endian)):
 ...
 */
    ...
    if (!__pyx_t_2) {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":246
 *                 t = descr.type_num
 *                 if ((descr.byteorder == '>' and little_endian) or
 *                     (descr.byteorder == '<' and not little_endian)):             # <<<<<<<<<<<<<<
 *                     raise ValueError(u"Non-native byte order not supported")
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":247
 *                 if ((descr.byteorder == '>' and little_endian) or
 *                     (descr.byteorder == '<' and not little_endian)):
 *                     raise ValueError(u"Non-native byte order not supported")             # <<<<<<<<<<<<<<
 *                 if   t == NPY_BYTE:        f = "b"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":248
 *                     (descr.byteorder == '<' and not little_endian)):
 *                     raise ValueError(u"Non-native byte order not supported")
 *                 if   t == NPY_BYTE:        f = "b"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_UBYTE:       f = "B"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":249
 *                     raise ValueError(u"Non-native byte order not supported")
 *                 if   t == NPY_BYTE:        f = "b"
 *                 elif t == NPY_UBYTE:       f = "B"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_SHORT:       f = "h"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":250
 *                 if   t == NPY_BYTE:        f = "b"
 *                 elif t == NPY_UBYTE:       f = "B"
 *                 elif t == NPY_SHORT:       f = "h"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_USHORT:      f = "H"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":251
 *                 elif t == NPY_UBYTE:       f = "B"
 *                 elif t == NPY_SHORT:       f = "h"
 *                 elif t == NPY_USHORT:      f = "H"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_INT:         f = "i"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":252
 *                 elif t == NPY_SHORT:       f = "h"
 *                 elif t == NPY_USHORT:      f = "H"
 *                 elif t == NPY_INT:         f = "i"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_UINT:        f = "I"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":253
 *                 elif t == NPY_USHORT:      f = "H"
 *                 elif t == NPY_INT:         f = "i"
 *                 elif t == NPY_UINT:        f = "I"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONG:        f = "l"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":254
 *                 elif t == NPY_INT:         f = "i"
 *                 elif t == NPY_UINT:        f = "I"
 *                 elif t == NPY_LONG:        f = "l"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_ULONG:       f = "L"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":255
 *                 elif t == NPY_UINT:        f = "I"
 *                 elif t == NPY_LONG:        f = "l"
 *                 elif t == NPY_ULONG:       f = "L"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONGLONG:    f = "q"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":256
 *                 elif t == NPY_LONG:        f = "l"
 *                 elif t == NPY_ULONG:       f = "L"
 *                 elif t == NPY_LONGLONG:    f = "q"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":257
 *                 elif t == NPY_ULONG:       f = "L"
 *                 elif t == NPY_LONGLONG:    f = "q"
 *                 elif t == NPY_ULONGLONG:   f = "Q"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_FLOAT:       f = "f"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":258
 *                 elif t == NPY_LONGLONG:    f = "q"
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 *                 elif t == NPY_FLOAT:       f = "f"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_DOUBLE:      f = "d"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":259
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 *                 elif t == NPY_FLOAT:       f = "f"
 *                 elif t == NPY_DOUBLE:      f = "d"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":260
 *                 elif t == NPY_FLOAT:       f = "f"
 *                 elif t == NPY_DOUBLE:      f = "d"
 *                 elif t == NPY_LONGDOUBLE:  f = "g"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":261
 *                 elif t == NPY_DOUBLE:      f = "d"
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 *                 elif t == NPY_CFLOAT:      f = "Zf"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":262
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 *                 elif t == NPY_CDOUBLE:     f = "Zd"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":263
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_OBJECT:      f = "O"
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":264
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"
 *                 elif t == NPY_OBJECT:      f = "O"             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":266
 *                 elif t == NPY_OBJECT:      f = "O"
 *                 else:
 *                     raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)             # <<<<<<<<<<<<<<
 *                 info.format = f
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":267
 *                 else:
 *                     raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)
 *                 info.format = f             # <<<<<<<<<<<<<<
 *                 return
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":268
 *                     raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)
 *                 info.format = f
 *                 return             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":270
 *                 return
 *             else:
 *                 info.format = <char*>stdlib.malloc(_buffer_format_string_len)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":271
 *             else:
 *                 info.format = <char*>stdlib.malloc(_buffer_format_string_len)
 *                 info.format[0] = '^' # Native data types, manual alignment             # <<<<<<<<<<<<<<
 *                 offset = 0
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":272
 *                 info.format = <char*>stdlib.malloc(_buffer_format_string_len)
 *                 info.format[0] = '^' # Native data types, manual alignment
 *                 offset = 0             # <<<<<<<<<<<<<<
 *                 f = _util_dtypestring(descr, info.format + 1,
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":275
 *                 f = _util_dtypestring(descr, info.format + 1,
 *                                       info.format + _buffer_format_string_len,
 *                                       &offset)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":276
 *                                       info.format + _buffer_format_string_len,
 *                                       &offset)
 *                 f[0] = 0 # Terminate format string             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":278
 *                 f[0] = 0 # Terminate format string
 * 
 *         def __releasebuffer__(ndarray self, Py_buffer* info):             # <<<<<<<<<<<<<<
...
static void __pyx_pf_5numpy_7ndarray___releasebuffer__(PyObject *__pyx_v_self, Py_buffer *__pyx_v_info) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":279
 * 
 *         def __releasebuffer__(ndarray self, Py_buffer* info):
 *             if PyArray_HASFIELDS(self):             # <<<<<<<<<<<<<<
 *                 stdlib.free(info.format)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":280
 *         def __releasebuffer__(ndarray self, Py_buffer* info):
 *             if PyArray_HASFIELDS(self):
 *                 stdlib.free(info.format)             # <<<<<<<<<<<<<<
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":281
 *             if PyArray_HASFIELDS(self):
 *                 stdlib.free(info.format)
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):             # <<<<<<<<<<<<<<
 *                 stdlib.free(info.strides)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":282
 *                 stdlib.free(info.format)
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 *                 stdlib.free(info.strides)             # <<<<<<<<<<<<<<
 *                 # info.shape was stored after info.strides in the same block
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":755
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew1(PyObject *__pyx_v_a) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":756
 * 
 * cdef inline object PyArray_MultiIterNew1(a):
 *     return PyArray_MultiIterNew(1, <void*>a)             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":758
 *     return PyArray_MultiIterNew(1, <void*>a)
 * 
 * cdef inline object PyArray_MultiIterNew2(a, b):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew2(PyObject *__pyx_v_a, PyObject *__pyx_v_b) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":759
 * 
 * cdef inline object PyArray_MultiIterNew2(a, b):
 *     return PyArray_MultiIterNew(2, <void*>a, <void*>b)             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":761
 *     return PyArray_MultiIterNew(2, <void*>a, <void*>b)
 * 
 * cdef inline object PyArray_MultiIterNew3(a, b, c):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew3(PyObject *__pyx_v_a, PyObject *__pyx_v_b, PyObject *__pyx_v_c) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":762
 * 
 * cdef inline object PyArray_MultiIterNew3(a, b, c):
 *     return PyArray_MultiIterNew(3, <void*>a, <void*>b, <void*> c)             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":764
 *     return PyArray_MultiIterNew(3, <void*>a, <void*>b, <void*> c)
 * 
 * cdef inline object PyArray_MultiIterNew4(a, b, c, d):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew4(PyObject *__pyx_v_a, PyObject *__pyx_v_b, PyObject *__pyx_v_c, PyObject *__pyx_v_d) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":765
 * 
 * cdef inline object PyArray_MultiIterNew4(a, b, c, d):
 *     return PyArray_MultiIterNew(4, <void*>a, <void*>b, <void*>c, <void*> d)             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":767
 *     return PyArray_MultiIterNew(4, <void*>a, <void*>b, <void*>c, <void*> d)
 * 
 * cdef inline object PyArray_MultiIterNew5(a, b, c, d, e):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew5(PyObject *__pyx_v_a, PyObject *__pyx_v_b, PyObject *__pyx_v_c, PyObject *__pyx_v_d, PyObject *__pyx_v_e) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":768
 * 
 * cdef inline object PyArray_MultiIterNew5(a, b, c, d, e):
 *     return PyArray_MultiIterNew(5, <void*>a, <void*>b, <void*>c, <void*> d, <void*> e)             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":770
 *     return PyArray_MultiIterNew(5, <void*>a, <void*>b, <void*>c, <void*> d, <void*> e)
 * 
 * cdef inline char* _util_dtypestring(dtype descr, char* f, char* end, int* offset) except NULL:             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE char *__pyx_f_5numpy__util_dtypestring(PyArray_Descr *__pyx_v_descr, char *__pyx_v_f, char *__pyx_v_end, int *__pyx_v_offset) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":777
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":778
 *     cdef tuple i
 *     cdef int endian_detector = 1
 *     cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)             # <<<<<<<<<<<<<<
 *     cdef tuple fields
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":781
 *     cdef tuple fields
 * 
 ...
 */
  ...
  for (;;) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":782
 * 
 *     for childname in descr.names:
 *         fields = descr.fields[childname]             # <<<<<<<<<<<<<<
 *         child, new_offset = fields
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":783
 *     for childname in descr.names:
 *         fields = descr.fields[childname]
 *         child, new_offset = fields             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":785
 *         child, new_offset = fields
 * 
 *         if (end - f) - (new_offset - offset[0]) < 15:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":786
 * 
 *         if (end - f) - (new_offset - offset[0]) < 15:
 *             raise RuntimeError(u"Format string allocated too short, see comment in numpy.pxd")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":788
 *             raise RuntimeError(u"Format string allocated too short, see comment in numpy.pxd")
 * 
 *         if ((child.byteorder == '>' and little_endian) or             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (!__pyx_t_7) {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":789
 * 
 *         if ((child.byteorder == '>' and little_endian) or
 *             (child.byteorder == '<' and not little_endian)):             # <<<<<<<<<<<<<<
 *             raise ValueError(u"Non-native byte order not supported")
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":790
 *         if ((child.byteorder == '>' and little_endian) or
 *             (child.byteorder == '<' and not little_endian)):
 *             raise ValueError(u"Non-native byte order not supported")             # <<<<<<<<<<<<<<
 *             # One could encode it in the format string and have Cython
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":800
 * 
 ...
 */
    while (1) {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":801
 *         # Output padding bytes
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":802
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte
 *             f += 1             # <<<<<<<<<<<<<<
 *             offset[0] += 1
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":803
 *             f[0] = 120 # "x"; pad byte
 *             f += 1
 *             offset[0] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":805
 *             offset[0] += 1
 * 
 *         offset[0] += child.itemsize             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":807
 *         offset[0] += child.itemsize
 * 
 *         if not PyDataType_HASFIELDS(child):             # <<<<<<<<<<<<<<
 *             t = child.type_num
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":808
 * 
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num             # <<<<<<<<<<<<<<
 *             if end - f < 5:
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":809
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num
 *             if end - f < 5:             # <<<<<<<<<<<<<<
 *                 raise RuntimeError(u"Format string allocated too short.")
 ...
 */
      ...
      if (__pyx_t_6) {
        ...
        /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":810
 *             t = child.type_num
 *             if end - f < 5:
 *                 raise RuntimeError(u"Format string allocated too short.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":813
 * 
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":814
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"             # <<<<<<<<<<<<<<
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":815
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"             # <<<<<<<<<<<<<<
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":816
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"             # <<<<<<<<<<<<<<
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":817
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"             # <<<<<<<<<<<<<<
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":818
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":819
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":820
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":821
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":822
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":823
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"             # <<<<<<<<<<<<<<
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":824
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":825
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"             # <<<<<<<<<<<<<<
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":826
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf             # <<<<<<<<<<<<<<
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":827
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd             # <<<<<<<<<<<<<<
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":828
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg             # <<<<<<<<<<<<<<
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":829
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":831
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 *             else:
 *                 raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":832
 *             else:
 *                 raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)
 *             f += 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":836
 *             # Cython ignores struct boundary information ("T{...}"),
 *             # so don't output it
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":837
 *             # so don't output it
 *             f = _util_dtypestring(child, f, end, offset)
 *     return f             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":952
 * 
 * 
...
static CYTHON_INLINE void __pyx_f_5numpy_set_array_base(PyArrayObject *__pyx_v_arr, PyObject *__pyx_v_base) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":954
 * cdef inline void set_array_base(ndarray arr, object base):
 *      cdef PyObject* baseptr
 *      if base is None:             # <<<<<<<<<<<<<<
 *          baseptr = NULL
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":955
 *      cdef PyObject* baseptr
 *      if base is None:
 *          baseptr = NULL             # <<<<<<<<<<<<<<
 *      else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":957
 *          baseptr = NULL
 *      else:
 *          Py_INCREF(base) # important to do this before decref below!             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":958
 *      else:
 *          Py_INCREF(base) # important to do this before decref below!
 *          baseptr = <PyObject*>base             # <<<<<<<<<<<<<<
 *      Py_XDECREF(arr.base)
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":959
 *          Py_INCREF(base) # important to do this before decref below!
 *          baseptr = <PyObject*>base
 *      Py_XDECREF(arr.base)             # <<<<<<<<<<<<<<
 *      arr.base = baseptr
 ...
 */
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":960
 *          baseptr = <PyObject*>base
 *      Py_XDECREF(arr.base)
 *      arr.base = baseptr             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":962
 *      arr.base = baseptr
 * 
 * cdef inline object get_array_base(ndarray arr):             # <<<<<<<<<<<<<<
 *     if arr.base is NULL:
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_get_array_base(PyArrayObject *__pyx_v_arr) {
  ...
  /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":963
 * 
 * cdef inline object get_array_base(ndarray arr):
 *     if arr.base is NULL:             # <<<<<<<<<<<<<<
 *         return None
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":964
 * cdef inline object get_array_base(ndarray arr):
 *     if arr.base is NULL:
 *         return None             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/usr/lib/pymodules/python2.5/Cython/Includes/numpy.pxd":966
 *         return None
 *     else:
 *         return <object>arr.base             # <<<<<<<<<<<<<<
 */
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("read_annotations"), (PyCFunction)__pyx_pf_3edf_read_annotations, METH_O, __Pyx_DOCSTR(__pyx_doc_3edf_read_annotations)},
  {__Pyx_NAMESTR("read_samplerate"), (PyCFunction)__pyx_pf_3edf_read_samplerate, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_3edf_read_samplerate)},
  {__Pyx_NAMESTR("read_samples"), (PyCFunction)__pyx_pf_3edf_read_samples, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_3edf_read_samples)},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__annotations_in_file, __pyx_k__annotations_in_file, sizeof(__pyx_k__annotations_in_file), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__dtype_f64, __pyx_k__dtype_f64, sizeof(__pyx_k__dtype_f64), 0, 0, 1, 1},
  {&__pyx_n_s__duration, __pyx_k__duration, sizeof(__pyx_k__duration), 0, 0, 1, 1},
  {&__pyx_n_s__edfsignal, __pyx_k__edfsignal, sizeof(__pyx_k__edfsignal), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__fromarrays, __pyx_k__fromarrays, sizeof(__pyx_k__fromarrays), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__onset, __pyx_k__onset, sizeof(__pyx_k__onset), 0, 0, 1, 1},
  {&__pyx_n_s__range, __pyx_k__range, sizeof(__pyx_k__range), 0, 0, 1, 1},
  {&__pyx_n_s__read_annotations, __pyx_k__read_annotations, sizeof(__pyx_k__read_annotations), 0, 0, 1, 1},
  {&__pyx_n_s__read_samplerate, __pyx_k__read_samplerate, sizeof(__pyx_k__read_samplerate), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initedf(void); /*proto*/
PyMODINIT_FUNC initedf(void)
#else
PyMODINIT_FUNC PyInit_edf(void); /*proto*/
PyMODINIT_FUNC PyInit_edf(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_edf(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("edf"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
  ...
  /* "/home/per/code/ptsa/ptsa/data/edf/edf.pyx":5
 * 
 * # set up the types
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__float64); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__dtype_f64, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_2));
  __pyx_t_1 = PyObject_GetAttr(__pyx_m, __pyx_n_s__read_annotations); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_GetAttr(__pyx_m, __pyx_n_s__read_samplerate); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_GetAttr(__pyx_m, __pyx_n_s__read_samples); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_GetAttrString(__pyx_t_1, "__doc__");
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init edf");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init edf");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
