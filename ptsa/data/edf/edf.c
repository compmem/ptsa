/* Generated by Cython 0.12.1 on Wed May 12 21:29:33 2010 */
 ...
 *     annotations = []
 */
  __pyx_t_2 = PyInt_FromLong(__pyx_v_hdr.annotations_in_file); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  __pyx_t_5 = PyInt_FromLong(__pyx_v_hdr.annotations_in_file); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
